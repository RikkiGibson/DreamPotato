...
cp $scriptroot/src/DreamPotato.MonoGame/Info.plist $scriptroot/artifacts/publish/DreamPotato.MonoGame/DreamPotato.app/Info.plist
...
iconutil -c icns $scriptroot/artifacts/bin/DreamPotato.MonoGame/release/DreamPotato.iconset --output $scriptroot/artifacts/publish/DreamPotato.MonoGame/DreamPotato.app/Contents/Resources/DreamPotato.icns
