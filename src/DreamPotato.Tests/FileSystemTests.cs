...
public class FileSystemTests : IDisposable
{
    ...
    public void WriteFiles_01()
    {
        ...
        Assert.Equal<object>("""
            ...
            02 | 33 80 C5 00 53 2E 41 52 43 41 44 49 41 30 30 31 
            03 | 20 23 07 19 22 47 30 03 1B 00 00 00 00 00 00 00 
            04 | 33 80 AA 00 53 2E 41 52 43 41 44 49 41 30 30 32 
            05 | 20 25 08 29 20 42 44 05 1B 00 00 00 00 00 00 00 
            06 | 33 80 8F 00 53 2E 41 52 43 41 44 49 41 30 30 33 
            07 | 20 25 09 13 10 32 30 06 1B 00 00 00 00 00 00 00 
            08 | CC FF 00 00 53 2E 41 52 43 41 44 49 41 5F 56 4D 
            09 | 20 25 09 29 18 32 18 01 53 00 01 00 00 00 00 00 
