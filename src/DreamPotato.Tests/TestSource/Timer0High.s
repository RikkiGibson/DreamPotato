...
;  /////////////////////////////////////////////////////////////
    .org $200
    .byte "Timer0HighTest  " ; ................... 16-byte Title
    .byte "Test Timer 0 High speed         " ; ... 32-byte Description
...
CountOnce:
    bn countModeFlag,0,.Exit  ; do not count if not in counting mode
    inc ticks0                ; inc LSB
    bne @R0, #0, .Exit  ; if no overflow, skip ahead
    inc ticks1                ; LSB overflowed, inc ticks1
    bne @R1, #0, .Exit  ; if no ticks1 overflow, skip ahead
