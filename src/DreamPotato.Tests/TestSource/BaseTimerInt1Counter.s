...
;  /////////////////////////////////////////////////////////////
  ...
  reti
    ...
    clr1 BTCR,3 ; clear base timer interrupt 1 source
  reti
  ...
  reti
    ...
    .org $1F0
goodbye:
    mov #%01000001, BTCR  ; disable int1 before exiting
    not1 EXT, 0   ;
...
Start:
    ...
    mov #%01110101, BTCR  ; enable base timer count, int0, int1, 2048/fBST int1 rate
...
CountMode:
    ...
    ; tick just a single time (carrying if needed.)
    inc ticks0                ; inc LSB
