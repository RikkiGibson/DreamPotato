...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImDrawListPtr
    {
        ...
        public void AddCallback(IntPtr callback)
        {
            void* userdata = null;
            uint userdata_size = 0;
            ImGuiNative.ImDrawList_AddCallback((ImDrawList*)(NativePtr), callback, userdata, userdata_size);
        }
        ...
        public void AddLineH(float min_x, float max_x, float y, uint col)
        {
            float thickness = 1.0f;
            ImGuiNative.ImDrawList_AddLineH((ImDrawList*)(NativePtr), min_x, max_x, y, col, thickness);
        }
        public void AddLineH(float min_x, float max_x, float y, uint col, float thickness)
        {
            ImGuiNative.ImDrawList_AddLineH((ImDrawList*)(NativePtr), min_x, max_x, y, col, thickness);
        }
        public void AddLineV(float x, float min_y, float max_y, uint col)
        {
            float thickness = 1.0f;
            ImGuiNative.ImDrawList_AddLineV((ImDrawList*)(NativePtr), x, min_y, max_y, col, thickness);
        }
        public void AddLineV(float x, float min_y, float max_y, uint col, float thickness)
        {
            ImGuiNative.ImDrawList_AddLineV((ImDrawList*)(NativePtr), x, min_y, max_y, col, thickness);
        }
        ...
        public void AddPolyline(ref Vector2 points, int num_points, uint col, float thickness)
        {
            ImDrawFlags flags = (ImDrawFlags)0;
            fixed (Vector2* native_points = &points)
            {
                ImGuiNative.ImDrawList_AddPolyline((ImDrawList*)(NativePtr), native_points, num_points, col, thickness, flags);
            }
        }
        public void AddPolyline(ref Vector2 points, int num_points, uint col, float thickness, ImDrawFlags flags)
        {
            fixed (Vector2* native_points = &points)
            {
                ImGuiNative.ImDrawList_AddPolyline((ImDrawList*)(NativePtr), native_points, num_points, col, thickness, flags);
        ...
        public void AddRect(Vector2 p_min, Vector2 p_max, uint col)
        {
            ...
            float thickness = 1.0f;
            ImDrawFlags flags = (ImDrawFlags)0;
            ImGuiNative.ImDrawList_AddRect((ImDrawList*)(NativePtr), p_min, p_max, col, rounding, thickness, flags);
        }
        ...
        public void AddRect(Vector2 p_min, Vector2 p_max, uint col, float rounding, float thickness)
        {
            ImDrawFlags flags = (ImDrawFlags)0;
            ImGuiNative.ImDrawList_AddRect((ImDrawList*)(NativePtr), p_min, p_max, col, rounding, thickness, flags);
        }
        public void AddRect(Vector2 p_min, Vector2 p_max, uint col, float rounding, float thickness, ImDrawFlags flags)
        {
            ImGuiNative.ImDrawList_AddRect((ImDrawList*)(NativePtr), p_min, p_max, col, rounding, thickness, flags);
        }
        ...
        public void PathStroke(uint col)
        {
            float thickness = 1.0f;
            ImDrawFlags flags = (ImDrawFlags)0;
            ImGuiNative.ImDrawList_PathStroke((ImDrawList*)(NativePtr), col, thickness, flags);
        }
        ...
        public void PathStroke(uint col, float thickness, ImDrawFlags flags)
        {
            ImGuiNative.ImDrawList_PathStroke((ImDrawList*)(NativePtr), col, thickness, flags);
        }
