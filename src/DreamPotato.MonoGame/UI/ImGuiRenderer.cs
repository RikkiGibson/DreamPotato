// Taken from https://github.com/ImGuiNET/ImGui.NET/blob/master/src/ImGui.NET.SampleProgram.XNA/ImGuiRenderer.cs
...
namespace DreamPotato.MonoGame.UI
{
    ...
    public class ImGuiRenderer
    {
        ...
        /// <summary>
        /// Creates a pointer to a texture, which can be passed through ImGui calls such as <see cref="ImGui.Image(nint, System.Numerics.Vector2)" />.
